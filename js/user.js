...
var loadLogin = function () {
  ...
  if (!signupArr[0]) {
    $(".btnOrderProducts").html(
      "<p>Hãy đăng nhập để được mua hàng!!!<br> <a href='user/signup.html'> Đăng nhập </a></p>"
    );
  }
};
...
function getName() {
  ...
  if (document.getElementById("doimk")) {
...
if (window.location.href.search("info") !== -1) {
  getName();
}
